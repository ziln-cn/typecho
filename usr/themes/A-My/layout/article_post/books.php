                ...
                <div class="info flex">
                    ...
                    <div class="flex-1 ml-5 grid items-center">
                        <div class="ml-3 grid items-center h-full">
                            ...
                            <p class="m-0">作者: <?php $this->fields->books_author(); ?></p>
                            <p class="m-0">出版时间: <?php $this->fields->books_time(); ?></p>
                            <p class="m-0">阅读进度: <?php $this->fields->books_reading(); ?></p>
                        </div>
                    </div>
                </div>
            </div>
